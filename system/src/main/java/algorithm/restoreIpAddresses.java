...
public class restoreIpAddresses {
    ...
    private void back(String s, int pos, List<String> cur,  List<String> ans) {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            // 继续递归遍历下一个位置
            System.out.println("pos="+pos+"    i="+i+"     segment="+segment+"   cur="+cur+"    ans="+ans);
